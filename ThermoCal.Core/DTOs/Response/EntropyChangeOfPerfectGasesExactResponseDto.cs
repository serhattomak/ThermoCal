...
public class EntropyChangeOfPerfectGasesExactResponseDto
{
    ...
    public double SZero { get; set; }
    public double SZeroFirst { get; set; }
    public double SZeroSecond { get; set; }
    public double SZeroFirstOver { get; set; }
    public double SZeroSecondOver { get; set; }
